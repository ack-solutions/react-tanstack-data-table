...
> Open the **Columns** menu in the toolbar (the ⊞ icon) — each column has **pin-left** / **pin-right**
> toggles next to its visibility checkbox. Click an active side again to unpin.
...
<DataTable
  ...
  data={rows}
  enableColumnPinning
  enableColumnVisibility   // surfaces the per-column pin toggles in the Columns menu
/>
```
