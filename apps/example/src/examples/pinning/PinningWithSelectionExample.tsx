/**
 * Pinning with Selection Example
 * 
 * Demonstrates column pinning combined with row selection, pinning the selection column to the left.
 */

import { DataTable, DataTableColumn, DEFAULT_SELECTION_COLUMN_NAME } from '@ackplus/react-tanstack-data-table';
...
export function PinningWithSelectionExample() {
  return (
    <DataTable
      columns={columns}
